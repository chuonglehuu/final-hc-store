  ...
  function reveal() {
    ...
    for (let i = 0; i < reveals.length; i++) {
      ...
      if (revealTop < windowHeight - revealPoint) {
        test = reveals[i].classList.add("active");
      } else {
        test = reveals[i].classList.remove("active");
      }
    }
  }
  return (
    <div className={cx("main")}>
        ...
        <div className={cx("wrapper")}>
          <div className={cx("intro-content")}>
            ...
            <p className={cx("desc")}>
              ...
              experience with the world's best phones. Furthermore, HC Store is
              the country's leading destination to purchase and sell secondhand
              phones. Customers have trusted and been delighted with the
              warranty policy at HC shop.
            </p>
      ...
      <div className={cx("take-care", "reveal", { test })}>
        <div className={cx("wrapper")}>
          ...
          <div className={cx("care-content")}>
            ...
            <p>
              The staff at HC Store is methodically trained to satisfy the needs
              of clients. When clients visit the store, they will be consulted
              precisely by each product to satisfy their demands. Furthermore,
              the personnel will eagerly exchange information about the store's
              marketing program and warranty policy. Meeting the demands of our
              consumers is the number one priority for us.
            </p>
          </div>
        </div>
      </div>
      <div className={cx("brand", "reveal", { test })}>
      ...
      <div className={cx("process", "reveal", { test })}>
        <div className={cx("content")}>
          ...
          <div className={cx("process-step")}>
            <div className={cx("step")}>
              ...
              <p className={cx("step-desc")}>
                Understanding consumer needs and leading customers on a tour of
                smartphone devices that meet their needs
              </p>
            </div>
            <div className={cx("step")}>
            ...
            <div className={cx("step")}>
              ...
              <p className={cx("step-desc")}>
                ...
                policy with customers at the HC Store. The current promotions of
            ...
            <div className={cx("step")}>
              ...
              <p className={cx("step-desc")}>
                Customers will be led to the checkout area and asked to examine
                their phones. You can pay in cash or by a bank transfer. HC
                Store also offers an online shopping option and a shipper who
