          ...
          <div className={cx("intro")}>
            <div className={cx("wrapper")}>
              <div className={cx("intro-content")}>
                ...
                <p className={cx("desc")}>
                  The most popular smartphone store in Vietnam is HC Store. The
                  HC Store has four locations: Hanoi, Hue, Da Nang, and Ho Chi
                  Minh City. Customers that visit HC Store will have a
                  one-of-a-kind experience with the world's best phones.
                  Furthermore, HC Store is the country's leading destination to
                  purchase and sell secondhand phones. Customers have trusted
                  and been delighted with the warranty policy at HC shop.
                </p>
            ...
            <div className={cx("wrapper")}>
              ...
              <div className={cx("care-content")}>
                ...
                <p>
                  ...
                  about the store's marketing program and warranty policy.
                  Meeting the demands of our consumers is the number one
                  priority for us.
                </p>
              </div>
            </div>
              ...
              <div className={cx("process-step")}>
                ...
                <div className={cx("step")}>
                  ...
                  <p className={cx("step-desc")}>
                    ...
                    dissatisfied, re-learn the customer's requirements and
                    provide the customer alternative phones.
                  </p>
                </div>
                <div className={cx("step")}>
                  <h4 className={cx("step-title")}>Step 3</h4>
                  <p className={cx("step-desc")}>
                    Once the customer is satisfied with the phone, double-check
                    it before handing it over to the customer. Discuss the
                    warranty policy with customers at the HC Store. The current
                    promotions of the store are available.
                  </p>
                </div>
                <div className={cx("step")}>
                  ...
                  <p className={cx("step-desc")}>
                    ...
                    transfer. HC Store also offers an online shopping option and
                    a shipper who will deliver to customers.
                  </p>
                </div>
              </div>
            </div>
